...
return apply_filters( 'wc_postfinance_settings',
    array(
        ...
        'checkout'                => array(
            'title'           => __( 'Checkout page translation', 'woocommerce-gateway-postfinance' ),
            'label'           => __( '', 'woocommerce-gateway-postfinance' ),
            'type'            => 'title',
            'description'     => '',
        ),
        'title'                   => array(
        ...
        'redirection_overlay'     => array(
            'title'           => __( 'Redirection overlay', 'woocommerce-gateway-postfinance' ),
            'type'            => 'text',
            'description'     => __( 'This controls the description which the user sees during checkout.', 'woocommerce-gateway-postfinance' ),
            'default'         => __( 'Sie werden über eine sichere Verbindung zu PostFinance weitergeleitet. ', 'woocommerce-gateway-postfinance', 'woocommerce-gateway-postfinance'),
            'desc_tip'        => true,
        ),
        'received'                => array(
            'title'           => __( 'Order received page translation', 'woocommerce-gateway-postfinance' ),
            'type'            => 'title',
            'description'     => '',
        ),
